...
export const CARD_LIST = [
  { trend: 'up', title: 'Revenue', icon: PersonIcon, color: 'warning', amount: 'MX$ 35,800', showCurrency: true, percentage: 10.23 },
  { trend: 'up', amount: 'MX$12,900', icon: PersonIcon, color: 'warning', percentage: 20.4, title: 'Repeat Purchase', showCurrency: false },
  { trend: 'down', amount: 'MX$1,000', icon: PersonIcon, color: 'warning', percentage: 10.23, title: 'Average Order value', showCurrency: true },
  { amount: 143, trend: 'down', icon: PersonIcon, color: 'warning', percentage: 10.23, title: 'New Customers', showCurrency: false },
]
