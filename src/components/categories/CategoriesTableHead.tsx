...
// ==============================================================
interface CategoriesTableHeadProps {
  order: 'asc' | 'desc'
  orderBy: string
  rowCount: number
  numSelected: number
...
export default function CategoriesTableHead(props: CategoriesTableHeadProps) {
  ...
  const headCells = [
    { id: 'name', numeric: false, disablePadding: false, label: t("categories") },
    { id: 'description', numeric: true, disablePadding: false, label: t("description") },
    { id: 'noOfProduct', numeric: true, disablePadding: false, label: t("no_of_product") },
