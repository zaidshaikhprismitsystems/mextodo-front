              ...
              <Grid container spacing={3}>
                ...
                <Grid size={{ sm: 6, xs: 12 }}>
                  {/* <TextField
                    ...
                    variant='standard'
                    name={"status"}
                    onChange={(event: any) => { console.log(event.target); setFieldValue("status", event.target.value) }}
                    value={values.status}
                ...
                <Grid size={12}>
                  <FlexBetween>
                    ...
                    <Switch disabled checked={values.approved} />
                  </FlexBetween>
                  ...
                  <FlexBetween mt={2}>
                    ...
                    <Switch disabled checked={values.stripeVendorVerified} />
                  </FlexBetween>
                </Grid>
