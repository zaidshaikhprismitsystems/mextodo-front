...
export default function UserInfo({isUpdate, enableUpdate, createdAt, checkVendorByPincode, isGetAddrLoading, pincode, isVerified}: any) {
  return (
    <ContentWrapper>
      ...
      <Box mt={2}>
        ...
        <FlexBetween marginTop={6} flexWrap="wrap">
          ...
          </FlexBox>
          {
              !isVerified && isUpdate ?
              <FlexBox gap={1}>
                  <LoadingButton loading={isGetAddrLoading} onClick={() => {checkVendorByPincode(pincode)}} size="small" color="info">
                    check address
                  </LoadingButton>
              </FlexBox>
              : ''
