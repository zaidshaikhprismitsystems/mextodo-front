        ...
        <Card sx={{ p: 2 }}>
          <Grid container spacing={3} alignItems="start">
            ...
            <Grid container spacing={2} size={{ md: 12, xs: 12 }}>
              ...
              <Grid container size={{ sm: 12, xs: 12 }} spacing={2}>
                ...
                <Grid size={{ sm: 6, xs: 12 }}>
                  <TextField
                    ...
                    name="product_id"
                    onChange={(e: any) => {setFieldValue("product_id", e.target.value)}}
                    value={values.product_id}
                    error={Boolean(touched.product_id && errors.product_id)}
                    helperText={touched.product_id && typeof errors.product_id === "string" ? errors.product_id : ""}
                  >
                  {
