      ...
      <Card className="" sx={{p:3}}>
        <Grid container spacing={3}>
          <Grid size={{ md: 7, xs: 12 }}>
            ...
            <H6 fontSize={14} mb={1}>
              Issue Date: <Span sx={{ color: 'text.secondary', fontWeight: 400 }}>03/10/2018</Span>
            </H6>

            <H6 fontSize={14}>
              Due date: <Span sx={{ color: 'text.secondary', fontWeight: 400 }}>07/10/2018</Span>
            </H6>

            <Scrollbar>
              <Table sx={{ mt: 3, minWidth: 375 }}>
                <TableHead>
                  <TableRow>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <BodyTableCell>MX$40.00</BodyTableCell>
                    <BodyTableCell>MX$3200.00</BodyTableCell>
                  </TableRow>

                  <TableRow>
                    <BodyTableCell>Logo Design</BodyTableCell>
                    <BodyTableCell>32</BodyTableCell>
                    <BodyTableCell>MX$50.00</BodyTableCell>
                    <BodyTableCell>MX$2200.00</BodyTableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </Scrollbar>
...
function ListItem({ text, description }: { text: string; description: string | ReactNode }) {
  return (
    <Paragraph color="text.secondary">
      {text} <br />
