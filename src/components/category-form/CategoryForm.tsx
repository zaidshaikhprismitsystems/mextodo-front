...
export default function CategoryForm(
  ...
  return (
    <Box
      ...
      <Box px={{ xs: 1, md: 3 }} pb={5} bgcolor={'rgba(255,255,255,0.1)'} sx={{ backdropFilter: 'blur(10px)', }}>
        <Fragment>
          <Card sx={{ padding: 3, position: 'relative', mt: 0, boxShadow:0, border:'1px solid rgb(223, 223, 223)', borderRadius:3 }}>
              ...
              <Grid container spacing={3}>
...

                {
                  ...
                  <Grid container spacing={2} sx={{py:0,}} >
                    ...
                    <fieldset aria-hidden="true" disabled={!isUpdate} style={{padding:'8px', border:'1px solid #e5e7eb', borderRadius:'8px',
                     
                    }} >
                      <legend style={{color:'#0009 ', fontWeight: 400, fontSize:'1rem', lineHeight:' 1.4375em',transform:'scale(0.75)'}} ><span>Image</span></legend>
                      
                        <FlexBox flexDirection="column" sx={{gap:1, p:'8px'}}>
                          <img src={imagePreview} width={200} height={200}  style={{borderRadius:'10px'}}/>
                        <Button disabled={!isUpdate} onClick={() => {removeImage()}}  sx={{}} color='error'>
                          {t("remove")}
                        </Button>
                        </FlexBox>
                      </fieldset>
