...
// ==============================================================
// Props
interface CouponsTableHeadProps {
  order: 'asc' | 'desc'
  orderBy: string
  rowCount: number
  numSelected: number
...
export default function CouponsTableHead({
  onSelectAllRows,
  order,
  orderBy,
  numSelected,
  ...
  const headCells = [
    ...
    { id: 'value', numeric: true, disablePadding: false, label: t('discount_value') },
