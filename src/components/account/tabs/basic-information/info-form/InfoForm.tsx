            ...
            <Grid container spacing={3}>
              <Grid size={{
                ...
                <TextField fullWidth name="firstName" label="First Name" variant="outlined"  onBlur={handleBlur} onChange={handleChange} value={values.firstName} helperText={touched.firstName && errors.firstName ? String(errors.firstName) : ""} error={Boolean(touched.firstName && errors.firstName)} 
                 slotProps={{
                  inputLabel: {
                    shrink: Boolean(values.firstName), // Shrink the label if there is a value
                  },
                }}
                />
              </Grid>
              ...
              <Grid size={{
                ...
                slotProps={{
                  inputLabel: {
                    shrink: Boolean(values.lastName), // Shrink the label if there is a value
                  },
                }}
                />
              </Grid>
              ...
              <Grid size={{
                ...
                slotProps={{
                inputLabel: {
                  shrink: Boolean(values.email), // Shrink the label if there is a value
                },
              }}
              />
              </Grid>
              ...
              <Grid size={{
                ...
                slotProps={{
                  inputLabel: {
                    shrink: Boolean(values.username), // Shrink the label if there is a value
                  },
                }}
                />
              </Grid>
              ...
              <Grid size={{
                ...
                slotProps={{
                  inputLabel: {
                    shrink: Boolean(values.currency), // Shrink the label if there is a value
                  },
                }}
                />
              </Grid>
