...
import { Button, TextField, Typography, Container, Autocomplete } from '@mui/material';
  ...
  const renderMenu = (
    ...
    >
      ...
      <Box px={2} pt={2} display={'flex'} alignItems={'center'} justifyContent={'space-between'}>
        <MenuItem sx={{ backgroundColor: 'primary.main', p: '10px 10px', width: 200, m: 0, borderRadius: 0 }}>   {
          userData.userDetails && userData.userDetails !== null ?
            <Typography variant='body1' fontSize={16} fontWeight={600} fontFamily={'Inter'} color={'white.main'} sx={{ textTransform: "capitalize" }}>{t("hi")} ,{userData.userDetails.username}</Typography>
            :
            <RouteLink to="/register"><Typography fontSize={18} fontWeight={600} color={'white.main'}> {t("create_account")}</Typography></RouteLink>
        }
        </MenuItem>
        <IconButton sx={{ p: 0, minWidth: 'auto' }} onClick={handleMenuClose}>
          <IconWrapper>
            <CloseIcon color="inherit" sx={{ color: '#000' }} />
          </IconWrapper>
        </IconButton>
      </Box>
      ...
      <Box px={2} pb={2} className="mobile-menu-items-wrap">
        ...
        <MenuItem sx={{ p: '10px 10px', width: 200, borderTop: '1px solid #858585', m: 0, borderRadius: 0 }} >
      ...
      <AppBar component="nav" sx={{ backgroundColor: primary[900], position: "sticky", paddingRight: '0 !important' }}>
        ...
        <Box sx={{ backgroundColor: primary.main, width: "100%", textAlign: "right", paddingBlock: { xs: '10px', md: '10px' }, }}>
          <Container sx={{ maxWidth: { lg: "lg", xl: "xl" }, display: "flex", alignItems: 'center', gap: '10px' }}>
            ...
            >
              <IconWrapper>
                <img alt={selectedLanguage.label} width={20} height={20} src={selectedLanguage.icon} style={{ marginRight: "4px", borderRadius: 0 }} />
              </IconWrapper>
            ...
            <Box sx={{ display: "flex", flexWrap: { xs: 'wrap', md: 'nowrap' }, justifyContent: 'space-between', alignItems: "center", width: "100%", gap: { xs: '10px', md: '23px' }, }}>
              ...
              <Box flex={{ xs: 'auto', sm: '1' }} sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center', justifyContent: 'end', width: "auto", maxWidth: "45%", order: { xs: '2', md: '3' } }}>
                ...
                <IconButton sx={{ padding: 0, }}>
                  <IconWrapper sx={{ minWidth: 48, width: 48, height: 'auto', }}>
                    <img src='/icon/shopping-cart.svg' height={48} width={48} className="cart_icon" style={{ borderRadius: 0 }} />
                  </IconWrapper>
                </IconButton>
              </Box>
            </Box>
            ...
            <Box mt={2} width={'100%'} display={'flex'} flexWrap={'wrap'} justifyContent={'space-between'}>
                ...
                <List disablePadding sx={{ display: 'flex', flexWrap: 'wrap', columnGap: '14px' }}>
                  <ListItem disablePadding sx={{ width: 'auto', display: { xs: 'none', md: 'block' }, }}>
                    <CustomSelect
                      ...
                      sx={{ border: 0, outline: 0, pr: "14px", cursor: 'pointer', fontSize: 20, fontWeight: 400, color: 'white.main', fontFamily: 'Inter, sans-serif', '& .MuiSvgIcon-root': { color: 'white.main', }, '& .MuiSelect-select': { color: 'white.main', }, }}
                    >
              ...
              <Box sx={{ display: { xs: 'none', md: 'flex' }, }}>
                <List disablePadding sx={{ display: 'flex', flexWrap: 'wrap', columnGap: '14px' }}>
                  ...
                  <Divider orientation="vertical" sx={{ borderColor: 'white.main' }} />
